import{g as v,a as u}from"./firestore-eDyhnHo-.js";let o=[],s="All";document.addEventListener("DOMContentLoaded",async()=>{const t=document.getElementById("news-grid-container");if(!t)return;h(t,6);const e=new URLSearchParams(window.location.search).get("cat");e&&(s=e),o=await v(),p(o),f(),g(),y(o)});function p(t){const r=document.getElementById("hero-featured-container");if(!r||t.length===0)return;const e=t.find(a=>a.featured)||t[0];e&&(r.innerHTML=`
